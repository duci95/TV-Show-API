        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedAt = table.Column<DateTime>(nullable: true),
                    Deleted = table.Column<bool>(nullable: false),
                    SponsorPicturePath = table.Column<string>(nullable: true),
                    SponsorURL = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowYear = table.Column<int>(nullable: false),
                    ShowPicturePath = table.Column<string>(nullable: true),
                    ShowLike = table.Column<int>(nullable: false),
                    ShowDislike = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActorShow", x => new { x.ActorId, x.ShowId });
                    table.ForeignKey(
